...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isiDaftarVideo();
        rvDaftarVideo = findViewById(R.id.recyclerView);
    ...
    public void isiDaftarVideo() {
        ...
        daftarVideo.add(new SumberVideo("Porsche 918", "Menikmati mobil sport Porsche 918 Spyder", "android.resource://" + getPackageName() + "/" + R.raw.porsche918));
        daftarVideo.add(new SumberVideo("Drift H2H", "Head to Head Drifting hasil cuplikan dari film The Fast and The Furious", "android.resource://" + getPackageName() + "/" + R.raw.drift01));
        daftarVideo.add(new SumberVideo("Kejar-kejaran", "Kejar-kejaran di jalanan hasil cuplikasn dari film The Fast and Furious", "android.resource://" + getPackageName() + "/" + R.raw.drift02));
